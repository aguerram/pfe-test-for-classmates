...
<![if !supportTabStrip]>
<link id="shLink" href="planning_2017-2018.fld/sheet001.htm">
...
<!--
 ...
 c_rgszSh[0] = "Planning des soutenances";
...
<![endif]><!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Planning des soutenances</x:Name>
    <x:WorksheetSource HRef="planning_2017-2018.fld/sheet001.htm"/>
   </x:ExcelWorksheet>
  </x:ExcelWorksheets>
  <x:Stylesheet HRef="planning_2017-2018.fld/stylesheet.css"/>
  <x:WindowHeight>14520</x:WindowHeight>
  <x:WindowWidth>24940</x:WindowWidth>
  <x:WindowTopX>1100</x:WindowTopX>
...
<frameset rows="*,39" border=0 width=0 frameborder=no framespacing=0>
 <frame src="planning_2017-2018.fld/sheet001.htm" name="frSheet">
 <frame src="planning_2017-2018.fld/tabstrip.htm" name="frTabs" marginwidth=0 marginheight=0>
 <noframes>
  <body>
